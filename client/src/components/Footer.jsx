...
const Footer = () => {
  return (
      <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 mt-4 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-white bg-orange-600">
                 ...
                 <Footprints size={30}/>
                    ...
                    <div>
                        ...
                        <ul className="mt-2 space-y-2">
                            ...
                            <li><a href="/" className="hover:text-indigo-600 transition">Careers<span className="text-xs text-orange-600 bg-white rounded-md ml-2 px-2 py-1">We’re hiring!</span></a></li>
                ...
                <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
                    ...
                    <p className="mt-3 text-center flex gap-2">© 2025 <Footprints/> ShooShop</p>
                </div>
            </footer>
  )
}
